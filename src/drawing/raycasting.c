...
/*                                                   +#+                      */
/*   Created: 2024/03/14 09:32:00 by cter-maa      #+#    #+#                 */
/*   Updated: 2024/03/14 09:45:55 by cter-maa      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// static t_hit	is_hit(t_cubed *c, double player_to_grid_x,
...
// 		{
// 			c->percentage_wall_width = fmod(y, 40) / 40;
// 			if (draw_ray_hit)
// 				drawPoint(c, x, y, c->colorOrange, dot_thickness);
// 			c->side = true;
// 			return (x_ray_hit);
// 		}
// 	}
...
// 			if (draw_ray_hit)
// 				drawPoint(c, x, y, c->colorBlue, dot_thickness);
// 			c->side = false;
// 			return (y_ray_hit);
// 		}
// 	}
